...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-subnet-public.auto.tfvars`
...
```bash
cd test/terratest/aws_subnet_public
./test.sh
```
