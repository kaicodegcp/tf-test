...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-route-table.auto.tfvars`
...
```bash
cd test/terratest/aws_route_table
./test.sh
```
