...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-s3-bucket-root.auto.tfvars`
...
```bash
cd test/terratest/aws_s3_bucket_root
./test.sh
```
