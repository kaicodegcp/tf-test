...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-s3-bucket-root.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-s3-bucket-root.auto.tfvars"
```
...
```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-s3-bucket-root.auto.tfvars"
```
