# aws-vpc-endpoint-databricks-relay (SE testing)
...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-vpc-endpoint-databricks-relay.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-vpc-endpoint-databricks-relay.auto.tfvars"
```

## What it creates

- Aws Vpc Endpoint Databricks Relay

## Cleanup

```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-vpc-endpoint-databricks-relay.auto.tfvars"
```
