...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-nat-gateway.auto.tfvars`
...
```bash
cd test/terratest/aws_nat_gateway
./test.sh
```
