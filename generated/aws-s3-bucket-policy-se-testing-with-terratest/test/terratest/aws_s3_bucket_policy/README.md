# aws_s3_bucket_policy Terratest
...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-s3-bucket-policy.auto.tfvars`
...
```bash
cd test/terratest/aws_s3_bucket_policy
./test.sh
```
