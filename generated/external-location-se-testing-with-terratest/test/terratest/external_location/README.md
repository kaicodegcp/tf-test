...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-external-location.auto.tfvars`
...
```bash
cd test/terratest/external_location
./test.sh
```
