# aws-iam-role-databricks-cross-account (SE testing)
...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-role-databricks-cross-account.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-role-databricks-cross-account.auto.tfvars"
```

## What it creates

- Aws Iam Role Databricks Cross Account

## Cleanup

```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-role-databricks-cross-account.auto.tfvars"
```
