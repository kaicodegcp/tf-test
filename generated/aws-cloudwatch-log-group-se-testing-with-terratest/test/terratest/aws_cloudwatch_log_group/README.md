# aws_cloudwatch_log_group Terratest
...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-cloudwatch-log-group.auto.tfvars`
...
```bash
cd test/terratest/aws_cloudwatch_log_group
./test.sh
```
