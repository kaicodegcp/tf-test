...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-security-group.auto.tfvars`
...
```bash
cd test/terratest/aws_security_group
./test.sh
```
