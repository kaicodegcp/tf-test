# aws-iam-policy-workspace (SE testing)
...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-policy-workspace.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-policy-workspace.auto.tfvars"
```

## What it creates

- Aws Iam Policy Workspace

## Cleanup

```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-policy-workspace.auto.tfvars"
```
