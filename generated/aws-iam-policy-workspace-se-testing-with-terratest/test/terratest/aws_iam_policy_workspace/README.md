# aws_iam_policy_workspace Terratest
...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-policy-workspace.auto.tfvars`
...
```bash
cd test/terratest/aws_iam_policy_workspace
./test.sh
```
