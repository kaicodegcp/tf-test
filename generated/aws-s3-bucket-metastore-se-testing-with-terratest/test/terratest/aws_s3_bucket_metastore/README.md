# aws_s3_bucket_metastore Terratest
...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-s3-bucket-metastore.auto.tfvars`
...
```bash
cd test/terratest/aws_s3_bucket_metastore
./test.sh
```
