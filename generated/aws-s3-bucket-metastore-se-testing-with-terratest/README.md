# aws-s3-bucket-metastore (SE testing)
...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-s3-bucket-metastore.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-s3-bucket-metastore.auto.tfvars"
```

## What it creates

- Aws S3 Bucket Metastore

## Cleanup

```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-s3-bucket-metastore.auto.tfvars"
```
