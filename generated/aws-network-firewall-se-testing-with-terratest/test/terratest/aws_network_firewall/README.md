# aws_network_firewall Terratest
...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-network-firewall.auto.tfvars`
...
```bash
cd test/terratest/aws_network_firewall
./test.sh
```
