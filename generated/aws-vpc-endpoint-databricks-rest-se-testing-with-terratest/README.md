# aws-vpc-endpoint-databricks-rest (SE testing)
...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-vpc-endpoint-databricks-rest.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-vpc-endpoint-databricks-rest.auto.tfvars"
```

## What it creates

- Aws Vpc Endpoint Databricks Rest

## Cleanup

```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-vpc-endpoint-databricks-rest.auto.tfvars"
```
