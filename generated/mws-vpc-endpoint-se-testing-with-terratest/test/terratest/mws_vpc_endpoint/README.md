...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-mws-vpc-endpoint.auto.tfvars`
...
```bash
cd test/terratest/mws_vpc_endpoint
./test.sh
```
