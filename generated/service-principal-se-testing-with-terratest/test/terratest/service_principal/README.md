...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-service-principal.auto.tfvars`
...
```bash
cd test/terratest/service_principal
./test.sh
```
