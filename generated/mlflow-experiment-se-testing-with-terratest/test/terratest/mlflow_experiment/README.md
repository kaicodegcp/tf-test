...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-mlflow-experiment.auto.tfvars`
...
```bash
cd test/terratest/mlflow_experiment
./test.sh
```
