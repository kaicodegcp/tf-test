...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-vpc-endpoint-s3.auto.tfvars`
...
```bash
cd test/terratest/aws_vpc_endpoint_s3
./test.sh
```
