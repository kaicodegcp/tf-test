# metastore_assignment Terratest
...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-metastore-assignment.auto.tfvars`
...
```bash
cd test/terratest/metastore_assignment
./test.sh
```
