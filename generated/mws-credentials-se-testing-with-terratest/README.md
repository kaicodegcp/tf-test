...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-mws-credentials.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-mws-credentials.auto.tfvars"
```

## What it creates

- Databricks account-level **MWS Credentials Configuration**:
...
```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-mws-credentials.auto.tfvars"
```
