...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-mws-credentials.auto.tfvars`
...
```bash
cd test/terratest/mws_credentials
./test.sh
```
