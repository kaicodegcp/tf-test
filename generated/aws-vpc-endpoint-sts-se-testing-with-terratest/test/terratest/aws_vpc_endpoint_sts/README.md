# aws_vpc_endpoint_sts Terratest
...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-vpc-endpoint-sts.auto.tfvars`
...
```bash
cd test/terratest/aws_vpc_endpoint_sts
./test.sh
```
