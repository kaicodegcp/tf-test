# aws-iam-instance-profile (SE testing)
...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-instance-profile.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-instance-profile.auto.tfvars"
```
...
```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-instance-profile.auto.tfvars"
```
