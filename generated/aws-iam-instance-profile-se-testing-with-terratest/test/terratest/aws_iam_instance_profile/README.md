# aws_iam_instance_profile Terratest
...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-instance-profile.auto.tfvars`
...
```bash
cd test/terratest/aws_iam_instance_profile
./test.sh
```
