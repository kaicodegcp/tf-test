# aws_firewall_rule_group Terratest
...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-firewall-rule-group.auto.tfvars`
...
```bash
cd test/terratest/aws_firewall_rule_group
./test.sh
```
