# aws-firewall-rule-group (SE testing)
...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-firewall-rule-group.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-firewall-rule-group.auto.tfvars"
```

## What it creates

- Aws Firewall Rule Group

## Cleanup

```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-firewall-rule-group.auto.tfvars"
```
