...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-sql-dashboard.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-sql-dashboard.auto.tfvars"
```
...
```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-sql-dashboard.auto.tfvars"
```
