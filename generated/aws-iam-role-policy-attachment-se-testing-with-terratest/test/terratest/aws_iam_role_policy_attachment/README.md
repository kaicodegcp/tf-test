# aws_iam_role_policy_attachment Terratest
...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-role-policy-attachment.auto.tfvars`
...
```bash
cd test/terratest/aws_iam_role_policy_attachment
./test.sh
```
