# aws-iam-policy-databricks (SE testing)
...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-policy-databricks.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-policy-databricks.auto.tfvars"
```

## What it creates

- Aws Iam Policy Databricks

## Cleanup

```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-iam-policy-databricks.auto.tfvars"
```
