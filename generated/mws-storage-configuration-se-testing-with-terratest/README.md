# mws-storage-configuration (SE testing)
...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-mws-storage-configuration.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-mws-storage-configuration.auto.tfvars"
```

## What it creates

- Databricks account-level **MWS Storage Configuration**:
...
```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-mws-storage-configuration.auto.tfvars"
```
