# mws_storage_configuration Terratest
...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-mws-storage-configuration.auto.tfvars`
...
```bash
cd test/terratest/mws_storage_configuration
./test.sh
```
