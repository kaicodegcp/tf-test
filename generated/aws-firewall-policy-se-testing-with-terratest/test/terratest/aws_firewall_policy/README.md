...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-firewall-policy.auto.tfvars`
...
```bash
cd test/terratest/aws_firewall_policy
./test.sh
```
