...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-subnet-private.auto.tfvars`
...
```bash
cd test/terratest/aws_subnet_private
./test.sh
```
