# aws-vpc-endpoint-kinesis (SE testing)
...
terraform plan  -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-vpc-endpoint-kinesis.auto.tfvars"
terraform apply -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-vpc-endpoint-kinesis.auto.tfvars"
```

## What it creates

- Aws Vpc Endpoint Kinesis

## Cleanup

```bash
cd infra/terraform/main
terraform destroy -var-file="aws-SE-99d097-databricks/us-east-1/terraform-aws-vpc-endpoint-kinesis.auto.tfvars"
```
