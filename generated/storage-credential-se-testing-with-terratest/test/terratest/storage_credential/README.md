...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-storage-credential.auto.tfvars`
...
```bash
cd test/terratest/storage_credential
./test.sh
```
