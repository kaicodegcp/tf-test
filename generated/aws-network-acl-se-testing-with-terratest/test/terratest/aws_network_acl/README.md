...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-aws-network-acl.auto.tfvars`
...
```bash
cd test/terratest/aws_network_acl
./test.sh
```
