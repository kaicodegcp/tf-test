...
- `infra/terraform/main/aws-SE-99d097-databricks/us-east-1/terraform-global-init-script.auto.tfvars`
...
```bash
cd test/terratest/global_init_script
./test.sh
```
